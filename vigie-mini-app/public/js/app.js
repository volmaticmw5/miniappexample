...
__webpack_require__(/*! ./jquery_ext */ "./resources/js/jquery_ext.js");


window.$ = window.jQuery = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"); // CHANGE THIS TO YOUR URL

var baseUri = "http://localhost/vigie-mini-app/vigie-mini-app/public/api"; // Button color change

var rbc = new _color__WEBPACK_IMPORTED_MODULE_0__.RandomBootstrapColors();
...
$('#addBtn').on('click', function () {
  ...
  $('#dynamicBtnHolder').html('Loading...'); // Send an ajax request and display the result on this button
...
$('#fakeForm').submit(function (event) {
  ...
  console.log("Last name: " + $('#lastName').val()); // Reset the fields
...
$('#productForm').submit(function (event) {
  ...
  console.log("Serial number: " + $('#productSerial').val()); // Reset the fields
...
$('#userForm').submit(function (event) {
  ...
  $('#userFormName').val("");
  $('#userFormAge').val(""); // Scroll to the bottom of the table
...
var btnColorCurrentIndex = 0;
var btnColorClasses = ['primary', 'secondary', 'success', 'danger', 'warning', 'info', 'light', 'dark'];

var RandomBootstrapColors = /*#__PURE__*/function () {
  function RandomBootstrapColors() {
    _classCallCheck(this, RandomBootstrapColors);
  }

  _createClass(RandomBootstrapColors, [{
    key: "getNewColorIndex",
    value: function getNewColorIndex() {
      var newIndex = Math.floor(Math.random() * btnColorClasses.length);
      if (newIndex === btnColorCurrentIndex) this.getNewColorIndex();
      if (btnColorClasses[newIndex] === 'undefined') this.getNewColorIndex();
      return newIndex;
    }
  }, {
    key: "getNewColorClass",
    value: function getNewColorClass() {
      btnColorCurrentIndex = this.getNewColorIndex();
      return btnColorClasses[btnColorCurrentIndex];
    }
  }]);

  return RandomBootstrapColors;
}();
